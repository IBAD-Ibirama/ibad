...
<style>
    ...
    .relatorio_competicao_ouro, .relatorio_atleta_colocacao_1, .relatorio_atleta_colocacao_Ouro {
        order: 1;
    }

    .relatorio_competicao_prata, .relatorio_atleta_colocacao_2, .relatorio_atleta_colocacao_Prata {
        order: 2;
    }

    .relatorio_competicao_bronze, .relatorio_atleta_colocacao_3, .relatorio_atleta_colocacao_Bronze {
        order: 3;
    }
...
<div class="area_impressao relatorio_competicao">
    ...
    <div class="relatorio_competicao_resultados">
        ...
        @if($atleta->results <= 3 && $atleta->results != 'Participante')
