                            ...
                            <li class="list-group-item">
                                ...
                                <div class="float-right flex mr-5-">
                                    <input type="checkbox" class="form-check-input"
                                        onclick="scoreAbsenceHelp(this, {{$help->id}})"
                                        {{$help->presence == true ? 'checked' : "" }} />
                                </div>
                            </li>
                            @empty
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item">
                                ...
                                <div class="float-right flex mr-5-">
                                    <input type="checkbox" class="form-check-input"
                                        onclick="markAbsenceAthlete(this, {{$athlete->id}})"
                                        {{$athlete->presence == true ? 'checked' : "" }} />
                                </div>
                            </li>
                            @empty
...
<script>
    ...
    const url = '{{ route('frequency.update', $training->id)}}';
