                            ...
                            <div class="row" id='form-auxiliarys'>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-danger">{!! $errors->first('auxiliary1')
                                            !!}</small>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-danger">{!! $errors->first('auxiliary2')
                                            !!}</small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id='num-treino' class="form-control" readonly value="" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
  ...
  const numTreino = document.querySelector("#num-treino");
