        ...
        <div class="col-md-12">
            ...
            <div class="card mt-3">
                <div class="card-header row w-100 align-items-start justify-content-between" style="margin: 0;">
                    ...
                    <div>
                        <a class='btn btn-primary btn-sm' href="{{route('team.add_withdrawal', $team->id)}}">Incluir</a>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="float-right flex">
                                <form style="display: inline" action="{{ route('withdrawal.delete', ['team' => $team->id, 'withdrawal' => $withdrawal->id]) }}" method="post">
                                    @csrf
                                    @method('DELETE')
