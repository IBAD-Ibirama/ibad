    ...
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header row w-100 align-items-start justify-content-between" style="margin: 0;">
          <span>{{ __('Todos os patrocinadores') }}</span>
          <a class='btn btn-success btn-sm' href="/sponsors/create">Criar novo patrocinador</a>
        </div>
        <div class="card-body">
          <ul class="list-group">
            @foreach($sponsors as $sponsor)
            <li class="list-group-item">
             <a href="/sponsors/{{$sponsor->id}}" title="Consultar">{{$sponsor->name}}</a>
